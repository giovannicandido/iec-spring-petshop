...
import com.example.petshop.domain.Cidade;
import com.example.petshop.domain.Cliente;
import com.example.petshop.domain.Endereco;
import com.example.petshop.domain.Especie;
import com.example.petshop.domain.Estado;
import com.example.petshop.domain.Funcionario;
import com.example.petshop.domain.PagCartao;
import com.example.petshop.domain.PagDinheiro;
import com.example.petshop.domain.Pagamento;
import com.example.petshop.domain.Raca;
import com.example.petshop.domain.Servico;
import com.example.petshop.domain.enuns.SituacaoPagamento;
import com.example.petshop.repository.CategoriaRepository;
import com.example.petshop.repository.CidadeRepository;
import com.example.petshop.repository.EnderecoRepository;
import com.example.petshop.repository.EspecieRepository;
import com.example.petshop.repository.EstadoRepository;
import com.example.petshop.repository.PagamentoRepository;
